...
Documentation is generated by two providers: [Docco](https://jashkenas.github.io/docco/) (`./docs/docco`) and [apiDoc](http://apidocjs.com/) (`./docs/apidoc`).  

### Docco
Any comments beginning with a `//` will be considered "prose" and formatted as text alongside the source code in the documentation. A specific file's documentation can be found in the generated HTML file with the same name.  
